...
| EventMix | [EventMix, Information Sciences 2023](https://floyedshen.github.io/pdf/shen2023eventmix.pdf) migliora nello stesso studio DVS-CIFAR10 e DVS-Gesture su più backbone, fino a +5,47 pp su DVS-Gesture con ResNet-34 | screen batch-level DVS-Gesture implementato con `p=0,5`, `Beta(1,1)`, tre componenti GMM e label a distanza; le scelte omesse dal paper sono esplicite nella config |
