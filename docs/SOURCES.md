...
|---|---|---|
| Temporal Maskout | [G2N2, BMVC 2023](https://proceedings.bmvc2023.org/660/) passa da 58,7% a 66,1% con otto maschere da 1–6 intervalli di 33 ms; il codice pubblico SpikGRU conferma maschere sovrapponibili | prima augmentation post-freeze sul solo modello congelato, configurazione unica 8×1–4 bin da 50 ms |
| Neuromorphic Data Augmentation | [NDA, ECCV 2022](https://www.ecva.net/papers/eccv_2022/papers_ECCV/papers/136670623.pdf) porta ResNet-19 su CIFAR10-DVS da 67,9% a 78,0%; M1N2 supera sia intensità più debole sia policy più aggressive | candidato principale per CIFAR10-DVS; su DVS-Lip si isola prima lo spatial erasing già supportato |
| EventMix | [EventMix, Information Sciences 2023](https://floyedshen.github.io/pdf/shen2023eventmix.pdf) migliora nello stesso studio DVS-CIFAR10 e DVS-Gesture su più backbone, fino a +5,47 pp su DVS-Gesture con ResNet-34 | candidato batch-level prioritario per DVS-Gesture e CIFAR10-DVS dopo l'integrazione dei dataset; richiede mixing 3D e target misti, quindi non viene confuso con gli screen sample-level correnti |
